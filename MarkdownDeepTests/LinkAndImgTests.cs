...
namespace MarkdownDeepTests {
	...
	internal class LinkAndImgTests {
		...
		[Test]
		public void ImageLink() => Assert.AreEqual("pre <a href=\"url.com\"><img src=\"url.com/image.png\" alt=\"alt text\" /></a> post",
		...
		[Test]
		public void InlineImgWithTitle() => Assert.AreEqual("pre <img src=\"url.com/image.png\" alt=\"alt text\" title=\"title\" /> post",
				s.Format("pre ![alt text](url.com/image.png \"title\") post"));

		[Test]
		public void InlineImgWithoutTitle() => Assert.AreEqual("pre <img src=\"url.com/image.png\" alt=\"alt text\" /> post",
				s.Format("pre ![alt text](url.com/image.png) post"));

		[Test]
		public void InlineLinkWithTitle() => Assert.AreEqual("pre <a href=\"url.com\" title=\"title\">link text</a> post",
				s.Format("pre [link text](url.com \"title\") post"));

		[Test]
		public void InlineLinkWithoutTitle() => Assert.AreEqual("pre <a href=\"url.com\">link text</a> post",
				s.Format("pre [link text](url.com) post"));

		[Test]
		public void MissingReferenceImg() => Assert.AreEqual("pre ![alt text][missing] post",
				s.Format("pre ![alt text][missing] post"));

		[Test]
		public void MissingReferenceLink() => Assert.AreEqual("pre [link text][missing] post",
				s.Format("pre [link text][missing] post"));


		[Test]
		public void ReferenceImgWithTitle() => Assert.AreEqual("pre <img src=\"url.com/image.png\" alt=\"alt text\" title=\"title\" /> post",
				s.Format("pre ![alt text][img1] post"));

		[Test]
		public void ReferenceImgWithoutTitle() => Assert.AreEqual("pre <img src=\"url.com/image.png\" alt=\"alt text\" /> post",
				s.Format("pre ![alt text][img2] post"));

		[Test]
		public void ReferenceLinkIdsAreCaseInsensitive() => Assert.AreEqual("pre <a href=\"url.com\" title=\"title\">link text</a> post",
				s.Format("pre [link text][LINK1] post"));

		[Test]
		public void ReferenceLinkWithTitle() => Assert.AreEqual("pre <a href=\"url.com\" title=\"title\">link text</a> post",
				s.Format("pre [link text][link1] post"));

		[Test]
		public void ReferenceLinkWithoutTitle() => Assert.AreEqual("pre <a href=\"url.com\">link text</a> post",
